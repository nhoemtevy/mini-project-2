...
export default function FooterComponent () {
    return (
        <>
            <div className="mt-8 bg-purple-200 pt-9">
                <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
                    <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
                    <div className="md:w-[316px]">
                        <div className="text-[18px] font-medium text-gray">
                        <p className="text-gray font-extrabold">
                        <span className="text-orange-600">YOUR</span>LOGO
                        </p>
                        </div>
                        <p className="mt-[18px] text-[15px] font-normal text-gray/[80%]">Lorem ipsum dolor sit amet consectetur adipisicing
                    ...
                    <div className="md:w-[316px]">
                        ...
                        <div className="ml-[18px]">
                            <a href="tel:+911800123444" className="font-Inter text-[14px] font-medium text-gray">+91 1800123444</a>
                            <p className="font-Inter text-[12px] font-medium text-gray-500">Support Number</p>
                        </div>
                        </div>
                        <div className="mt-[23px] flex">
                        <div className="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
                        ...
                        <div className="ml-[18px]">
                            <a href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium text-gray">help@lorem.com</a>
                            <p className="font-Inter text-[12px] font-medium text-gray-500">Support Email</p>
                        </div>
                        </div>
                        <div className="mt-[23px] flex">
                        <div className="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
                        ...
                        <div className="ml-[18px]">
                            <a href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium text-gray">Sub Nerul, Mumbia,
                            India, 123456</a>
                            <p className="font-Inter text-[12px] font-medium text-gray-500">Address</p>
                        </div>
                        </div>
                    </div>
                    <div className="mt-6 flex w-full flex-col justify-between text-gray sm:flex-row md:mt-0 md:max-w-[341px]">
                        <div className="">
                    ...
                    <p className="text-[10px] font-normal text-gray md:text-[12px]">
